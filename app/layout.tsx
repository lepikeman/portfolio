...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://www.xhaflaireaxel.com"), // Remplacez par votre domaine
  alternates: {
    canonical: "/",
    languages: {
      "fr-FR": "/fr",
  ...
  verification: {
    google: "votre-code-google-search-console", // Ajoutez votre code de vérification Google
